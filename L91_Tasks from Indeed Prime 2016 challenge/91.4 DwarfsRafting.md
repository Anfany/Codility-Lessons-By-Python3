...
首先根据字符串获得右上，右下，左上，左下，已经被木桶和矮人占据的座位。然后计算出：

  * 右上和左下两部分中剩余座位较少的，假设为S1
  
  * 右下和左上两部分中剩余座位较少的，假设为S2
  
如果保持平衡，则可以按照下面的方案： 右上，左下两部分均承载S1个人，  右下，左上两部分均承载S2个人，则木筏肯定可以保持平衡。并且2\*(S1+S2)是可以承载的最大人数。
